...
export default function AboutPage() {
  return (
    <div id="about" className="md: justify-center gap-20 items-center">
      <div className="justify-start">
        <h1 className="text-4xl md:text-3xl font-bold mt-7 text-center md:text-center">
          About $SAINT
        </h1>
      </div>
        ...
        <div className="grid gap-14 md:grid-cols-2 md:gap-5">
          <div className="rounded-xl bg-white p-6 text-center shadow-xl">
            ...
            <p className="px-4 text-gray-500">
              Satoshi AI agent is an innovative shift in the world of blockchain
              intelligence, inspired by the ethos of Satoshi Nakamoto’s vision.
              By leveraging the power of AI and deep learning, $SAINT transforms
              the overwhelming complexity of blockchain data into streamlined,
              actionable insights. Designed with both novice and seasoned crypto
              users in mind, it provides real-time tracking, comprehensive
              analytics, and robust tools to facilitate informed decisions and
              seamless interactions within the blockchain ecosystem.
            </p>
          </div>
          <div
            data-aos-delay="150"
          ...
          >
            ...
            <p className="px-4 text-gray-500">
              ...
              AI-driven platform that simplifies blockchain interactions. $SAINT
              seeks to provide actionable insights and support user autonomy,
              making complex data accessible, understandable, and valuable for
          ...
          >
            ...
            <p className="px-4 text-gray-500">
              At the heart of $SAINT’s success is a dedicated team of blockchain
              experts, AI specialists, and tech innovators committed to creating
              a transformative user experience. The development team
              collaborates closely to integrate advanced machine learning
              algorithms, ensuring that the platform stays ahead in delivering
              reliable, up-to-date analytics.
            </p>
          </div>
          <div
            data-aos-delay="300"
          ...
          >
            ...
            <p className="px-4 text-gray-500">
              As blockchain technology progresses, $SAINT stands as a beacon of
              innovation aligned with the principles set forth by Satoshi
              Nakamoto. The roadmap is ambitious yet focused, comprising four
              key phases: Data Collection and AI Model Development, Core Feature
              Launch, Expansion of Cross-Chain and Security Capabilities, and
